...
## Active Blockers
| Blocker ID | Layer | Description | Impact | Status | Next Check |
|---|---|---|---|---|---|
...
- If a blocker affects writeback safety, keep external layers read-only.
- Each blocker update should append one related log entry.
